...
<section class="section" style="background-color: var(--bg-light); padding: var(--spacing-lg) 0;">
    <div class="container">
        <div style="display: flex; align-items: center; gap: var(--spacing-lg); max-width: 960px; margin: 0 auto; flex-wrap: wrap;">

            <div style="flex: 0 0 auto; width: 280px; max-width: 100%;">
                <img src="{{ '/static/images/CVPR_Denver_2026.jpg' | relative_url }}"
                     alt="CVPR 2026 Denver"
                     style="width: 100%; border-radius: var(--border-radius); box-shadow: 0 4px 16px rgba(0,33,69,0.12);">
            </div>
    ...
    <div class="container">
        ...
        <div class="organizers-grid">
            <div class="organizer-card">
                ...
                <p class="organizer-affiliation">PhD Student, UBC</p>
            ...
            <div class="organizer-card">
                ...
                <p class="organizer-affiliation">PhD Candidate, UBC</p>
            ...
            <div class="organizer-card">
                ...
                <p class="organizer-affiliation">Assistant Professor, York University; Faculty Affiliate, Vector Institute</p>
            ...
            <div class="organizer-card">
                ...
                <p class="organizer-affiliation">Assistant Professor, UBC; Faculty Member, Vector Institute</p>
            ...
            <div class="organizer-card">
                ...
                <p class="organizer-affiliation">Professor and Director, MURGe-Lab, UNC Chapel Hill</p>
            ...
            <div class="organizer-card">
                ...
                <p class="organizer-affiliation">Professor, UBC; Faculty Member, Vector Institute</p>
